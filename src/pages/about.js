            ...
            <Row>
              ...
              <Col>
                <div className="about__desc">
                  ...
                  <p className="about__text text">Вот ссылочки на <a className="gradient gradient_pink" href="https://adaptable-flavor-c60.notion.site/5ff3b4670f4941d683bc3f7d7e63e929" target="_blank" rel="nofollow noopener noreferrer">дизайнера</a> и <a className="gradient gradient_blue" href="https://llinh9ra.ru/" target="_blank" rel="nofollow noopener noreferrer">backend-разработчика</a>.</p>
                </div>
